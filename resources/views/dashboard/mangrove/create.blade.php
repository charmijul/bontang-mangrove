        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="col-lg-8">
                        <form method="post" action="/dashboard/mangrove" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('scientifik_name') is-invalid @enderror"
                                    name="scientifik_name" id="scientifik_name" required autofocus value="{{ old('scientifik_name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control @error('benefit') is-invalid @enderror"
                                    name="benefit" id="benefit" required value="{{ old('benefit') }}">
